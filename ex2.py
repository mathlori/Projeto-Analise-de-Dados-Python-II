# Utilizando a mesma database da Avaliação continuada 1, 
# irei analisar o comportamento da probabiliadde de um
# indivíduo conter diabetes de acordo com o peso desse.
# Ambos os dados se encontram no mesmo dataset. Nesse 
# contexto, temos  a probabilidade como variável resposta (y)
# e o peso como # variável explicativa (x).
...
# Variáveis sobre os dados

# Importar o arquivo CSV
database = pd.read_csv('diabetes.csv')

# Selecionar as colunas 'Age' e 'DiabetesPedigreeFuncion'
x = database['Age'].tolist()
y = database['DiabetesPedigreeFunction'].tolist()
